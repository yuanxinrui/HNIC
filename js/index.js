...
app.controller('myCtrl', function($scope,$sce) {
    ...
    var firstUrl = 'http://10.191.47.199:28081/spreadsheet/vision/openresource.jsp?resid=' + arrUrl[0].childIdList[0].id + '&username=demo&password=demo&showtoolbar=false';
    $scope.reportUrl = $sce.trustAs($sce.RESOURCE_URL,firstUrl);
    $scope.arr = arrUrl;
    $scope.arrChild = [];
    $scope.arrUrlFirstId=[];
    $scope.urlTest =[];
